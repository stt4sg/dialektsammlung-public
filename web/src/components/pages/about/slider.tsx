  ...
  return (
    <div className="partner-slider">
      <div className="slider-container">
        <img className="dots-right" src={require('./images/slider-dots.png')} alt="" />
        ...
        <div className="slider-content">
          <div className="slider-controls">
            ...
            <div className="arrows">
              <div
                className={classnames('slider-arrow', { disabled: activeSlide === 0 })}
                onClick={() => {
                  if (activeSlide !== 0) {
          ...
          <div className="slides-viewport" style={{ left: `-${activeSlide * 100}%` }}>
