...
import { CheckIcon, CrossIcon, LinkIcon, MicIcon, ShareIcon, TrashIcon } from '../../../ui/icons';
import { Button } from '../../../ui/ui';
import { PlayButton, Voice } from '../../../primary-buttons/primary-buttons';
...
class AvatarSetup extends React.Component<Props, State> {
  ...
  render() {
    ...
    const avatarType = account.avatar_url && account.avatar_url.startsWith('https://gravatar.com') ? 'gravatar' : null;
...
export default connect<PropsFromState, any>(({ api, locale, user }: StateTree) => ({ api, locale, user }), {
