  ...
  (
    ...
    <div ref={ref} className={'banner ' + className} {...props}>
      ...
      {bannerProps.links.map((cta: any, key: number) => {
        ...
        return <LinkButton {...cta} key={`banner-link-${key}`} onClick={persistAfterClick ? null : onClose} />;
      })}
...
export default function NotificationBanner({ notification }: { notification: Notifications.Notification }) {
