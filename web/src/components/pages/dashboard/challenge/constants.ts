...
export const weeklyChallengeCopy = [
  {
    ...
    explanation: 'This is the percentage of team invites that have been accepted out of the current total sent.',
  },
  {
    title: "Let's get social",
    subtitle: 'The most socially active team wins the prize',
    explanation: 'This is the number of invites your team has sent inviting others to join the Open Voice Challenge',
  },
  {
