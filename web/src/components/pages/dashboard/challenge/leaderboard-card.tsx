...
export default function LeaderboardCard({
  ...
  return (
    <StatsCard
      ...
      tabs={{
        recorded: () => <ChallengeList key="recorded-list" type="clip" service={service} ref={leaderboardRef} />,
        validated: () => <ChallengeList key="validated-list" type="vote" service={service} ref={leaderboardRef} />,
      }}
    />
  );
}
