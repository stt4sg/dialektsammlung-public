...
import { CogIcon, DashboardIcon, LogoutIcon, MenuIcon, UserIcon } from '../ui/icons';
    ...
    <div>
      <div
        ...
        <button className="toggle">
          <div className="username-btn" onMouseEnter={playAvatar} onMouseLeave={playAvatar} onClick={playAvatar}>
            <div>
