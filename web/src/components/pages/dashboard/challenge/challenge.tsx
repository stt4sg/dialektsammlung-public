  ...
  return (
    <div className="leaderboard-overlay">
      ...
      <p className="explainer">
        This setting controls your leaderboard visibility. When hidden, your progress will be private. This means your
        image, user name and progress will not appear on the leaderboard.
      </p>
      <div className="info">
        <InfoIcon />
        <p className="note">
...
function ChallengePage(props: Props & RouteComponentProps<any, any, any>) {
  ...
  const [showOnboardingModal, setShowOnboardingModal] = useState(props.location.state?.showOnboardingModal);
